/*
 * $Id: array.h,v 1.5 2006/08/15 14:26:42 srirams Exp $
 *
 */
#ifndef ARRAY_H
#define ARRAY_H
...
EXTERN void array_sort3 ARGS((array_t *, int (*)(const void *, const void *)));
#define array_sort(a,f) array_sort3(a,(int(*)(const void *, const void *))(f))
