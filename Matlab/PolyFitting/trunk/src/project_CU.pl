...
# global settings
# X : [6.952077 - 73.441025], Y : [-1.868422 - 46.463326], Z : [17.410786 - 72.120827]
my $sample_num=1000;
my $root_dir="result/point_cloud_CU_$sample_num";
my $dataset="../data/pts/CooperUnion_trans.ptx";
my $im_w=1024;
my $im_h=1024;
...
my $z_min = 12.41;
my $z_max = 72.12;
# -x 1.95 -X 78.44 -y -6.86 -Y 46.46 -z 12.41 -Z 72.12
