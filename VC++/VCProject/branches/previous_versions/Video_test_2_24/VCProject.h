...
void camera_calibrate(BYTE **&image,Bitmap *&bitmap, BYTE **&ppt_image, Bitmap *&bitmap_ppt);
void transformation(Bitmap *&result, Bitmap *A_bitmap, Bitmap *C_bitmap, double *params);
void overlap_coarse(BYTE **ppt_image, BYTE **mimio_image, Bitmap *&result, int width, int height);
