...
void camera_calibrate ( BYTE **&ppt_image,Bitmap *&ppt_bitmap )
{
    ...
    CLSID  clsid;
	int y, x;	
	Bitmap* bitmap0= new Bitmap(L"image\\pre-camera.jpg");
	GetEncoderClsid(L"image/bmp", &clsid);
 	Bitmap* bitmap1 = new Bitmap(L"image\\post-camera.jpg");
...
/**/
	image = oimage; image_note = oimage_note;
